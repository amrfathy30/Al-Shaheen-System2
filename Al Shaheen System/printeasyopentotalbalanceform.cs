...
{
    public partial class printeasyopentotalbalanceform : Form
    {
        DatabaseConnection myconnection = new DatabaseConnection();
        SH_EMPLOYEES mEmployee;
        SH_USER_ACCOUNTS mAccount;
        SH_USER_PERMISIONS mPermission;
        public printeasyopentotalbalanceform(SH_EMPLOYEES anyemp, SH_USER_ACCOUNTS anyAccount, SH_USER_PERMISIONS anyPermission)
        {
            InitializeComponent();
            mEmployee = anyemp;
            mAccount = anyAccount;
