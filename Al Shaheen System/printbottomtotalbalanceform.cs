...
{
    public partial class printbottomtotalbalanceform : Form
    {
        DatabaseConnection myconnection = new DatabaseConnection();
        SH_EMPLOYEES mEmployee;
        SH_USER_ACCOUNTS mAccount;
        SH_USER_PERMISIONS mPermission;
        public printbottomtotalbalanceform(SH_EMPLOYEES anyemp , SH_USER_ACCOUNTS anyAccount ,SH_USER_PERMISIONS anyPermission)
        {
            InitializeComponent();
            mEmployee = anyemp;
            mAccount = anyAccount;
        ...
        private void printbottomtotalbalanceform_Load(object sender, EventArgs e)
        {
            ...
            myparams[5] = new ReportParameter("doc_title_text", "الأرصدة من المنتج التام ( القاع )",false);
