...
{
    public partial class woodenfacepotalform : Form
    {
        ...
        private void listView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            switch (currentitem.Index)
            {
                case 0:
                    {
                        wooden_face_data_profile myform = new wooden_face_data_profile("110*120",120,110,mEmployee,mAccount,mPermission);
                        myform.Show();
                        break;
                    }
                case 1:
                    {
                        wooden_face_data_profile myform = new wooden_face_data_profile("110*130",130,110, mEmployee, mAccount, mPermission);
                        myform.Show();
                        break;
                    }
                case 2:
                    {
                        wooden_face_data_profile myform = new wooden_face_data_profile("90*135", 135, 90, mEmployee, mAccount, mPermission);
                        myform.Show();
                        break;
                    }
                case 3:
                    {
                        wooden_face_data_profile myform = new wooden_face_data_profile("80*100", 100, 80, mEmployee, mAccount, mPermission);
                        myform.Show();
                        break;
                    }
                default:
