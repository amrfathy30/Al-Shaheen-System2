...
{
    public partial class Bottomaddingform : Form
    {
        ...
        private void save_BOTTOM_btn_Click(object sender, EventArgs e)
        {
            bool cansave = true;
        ...
        void saveeasyopencontainers(long sp_id , long qu_id)
        {
            try
            {
                ...
                query += " VALUES(@SH_QUANTITY_OF_BOTTOM_ID,@SH_SPECIFICATION_OF_BOTTOM_ID,@SH_CONTAINER_NAME,@SH_TOTAL_NO_ITEMS,@SH_ADDITION_DATE)";
                DatabaseConnection myconnection = new DatabaseConnection();
                myconnection.openConnection();
                SqlCommand cmd = new SqlCommand(query , DatabaseConnection.mConnection);
