...
namespace Al_Shaheen_System
{
    public class SH_CLIENTS_PRODUCTS
    {
        ...
        public long SH_TWIST_SIZE_ID { get; set; }
        public string SH_TWIST_SIZE_NAME { get; set; }
        public string SH_TWIST_TYPE { get; set; }
        public long SH_TWIST_TYPE_ID { get; set; }
        public string SH_TWIST_TYPE_KIND { get; set; }
    }
}
