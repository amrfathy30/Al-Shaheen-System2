...
{
    class SH_PALLETS_OF_CUT_MURAN_MATERIAL
    {
        public long SH_ID { get; set; }
        public long SH_SPECIFICATION_OF_CUT_MURAN_MATERIAL_ID { get; set; }
        public long SH_QUANTITIES_OF_CUT_MURAN_MATERIAL_ID { get; set; }
        ...
        public long SH_NUMBER_OF_BOTTELS_PER_SEQUENCE { get; set; }
        public long SH_NUMBER_OF_BOTTELS_PER_PALLET { get; set; }
    }
}
