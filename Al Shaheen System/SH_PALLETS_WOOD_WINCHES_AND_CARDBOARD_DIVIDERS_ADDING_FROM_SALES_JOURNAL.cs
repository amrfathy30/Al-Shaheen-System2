...
{
    public class SH_PALLETS_WOOD_WINCHES_AND_CARDBOARD_DIVIDERS_ADDING_FROM_SALES_JOURNAL
    {
        public long SH_ID { get; set; }
        public long SH_RECEIVING_PERMISSION_INFORMATION_ID { get; set; }
        public long SH_PALLETS_WOOD_WINCHES_AND_CARDBOARD_DIVIDERS_ID { get; set; }
        public long SH_CLIENT_ID { get; set; }
        public long SH_STOCK_ID { get; set; }
        public long SH_STOCK_MAN_ID { get; set; }
        public string SH_DISMISSAL_PERMISSION_NUMBER { get; set; }
